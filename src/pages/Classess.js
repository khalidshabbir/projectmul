...
const Classess = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(base_url + '/register_classes',
  ...
  const handleDelete = async (classroomId) => {
    try {
      ...
      const response = await axios.delete(base_url + `/delete_classes/${classroomId}`);
  ...
  useEffect(() => {
    const fetchClassrooms = async () => {
      try {
        const response = await axios.get(base_url + '/get_classes');
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form>
              <div className='p-3'>
                <div class="mb-3">
                  <label for="forclassrooms" class="form-label">Enter Class Name</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <form>
              <div className='p-3'>
                <div class="mb-3">
                  <label for="forclassrooms" class="form-label">Edit Class</label>
